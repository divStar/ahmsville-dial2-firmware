 ...
 *
 * This class is a ISchedulableDialTask, that handles the capacitative touch
 * button sensorAdapter.
 *
 * @author  Igor Voronin
 * @date    29.07.2023
 */
...
private:
  /**
   * @brief Amount of samples taken into account when detecting the
   * sensorAdapter value.
   */
  ...
  /**
   * @brief Command to handle sending retrieved sensorAdapter values to the
   * Serial port.
   *
   * @param sensorValue (long) sensorAdapter value retrieved from the
   * sensorAdapter
   */
