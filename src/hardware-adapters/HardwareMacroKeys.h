 ...
 * @brief   The actual hardware implementation of the macro key sensors adapter used by the application.
 *
 * @author  Igor Voronin
 * @date    06.08.2023
 */
...
public:
     ...
     * @brief Constructor.
     *
     * @param taskType (const char*) name of the task responsible for the macro keys
     */
