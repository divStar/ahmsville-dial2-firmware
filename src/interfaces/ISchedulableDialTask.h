 ...
 * @brief   Inherits from Task and DialTask to provide one class for Tasks to
 * implement.
 *
 * This abstract class inherits form Task and DialTask and thereby allows its
 * subclasses to implement a single class.
 *
 * @author  Igor Voronin
 * @date    27.07.2023
 */
...
public:
   ...
   * @brief Constructor.
   *
   * @param taskType  (const char*) name of the task type (e.g. "haptic" or
   * "led")
   */
