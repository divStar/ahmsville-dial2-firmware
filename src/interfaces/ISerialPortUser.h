 ...
 * @brief   Provides function signatures, that an output producer subclass must implement.
 *
 * This abstract class provides function signatures, that determine a subclass as an output producer.
 *
 * @author  Igor Voronin
 * @date    03.08.2023
 */
