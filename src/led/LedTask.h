 ...
 *
 * This class is a ISchedulableDialTask, that handles the LEDs on the AhmsVille
 * Dial2.
 *
 * @author  Igor Voronin
 * @date    06.07.2023
...
public:
   ...
   * list containing messages to be processed
   */
...
private:
  ...
  /**
   * @brief JSON-formatted filter string, that describes which attributes are
   * kept when parsing a message.
   */
