...
MacroKey::MacroKey(int keyId, int pin)
    : ISerialPortUser(configuredSerialPort()), keyId(keyId), pin(pin), riseTime(0), fallTime(0), lastInterrupttime(0), type("macrokey") {}

int MacroKey::getPin() const { return pin; }
...
void MacroKey::setType(const char *newType) { this->type = newType; }
